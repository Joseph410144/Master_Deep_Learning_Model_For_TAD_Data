...
from UnetModel.ConvTimeNet.Layer import *
from UnetModel.ConvTimeNet.RevIN import RevIN
...
if __name__ == "__main__":
    model = ConvTimeNet_backbone(c_in=8, seq_len=int(5*60*100), context_window = int(5*60*100),
